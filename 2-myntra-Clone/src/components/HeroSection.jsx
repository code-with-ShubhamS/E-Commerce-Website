...
const HeroSection = () => {
  return (
   <>
   <main className="myMainBackgroundImg">
    ...
    <div className="container grid grid-two--cols">
      <div className="section-hero--content">
        ...
        <p className="hero-para">
          Welcome to Semwal eComStore, your ultimate destination for
        ...
        <div className="hero-btn">
          ...
          <Link to={"/"}><button type="button" className="btn btn-dark">Explore Our Products</button></Link>
        </div>
      </div>
